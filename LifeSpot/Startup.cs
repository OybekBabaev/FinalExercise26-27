...
namespace LifeSpot
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            var footerHtml = File.ReadAllText(Path.Combine(Directory.GetCurrentDirectory(),
                "Views", "Shared", "footer.html"));
            var sidebarHtml = File.ReadAllText(Path.Combine(Directory.GetCurrentDirectory(),
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                {
                    var viewPath = Path.Combine(Directory.GetCurrentDirectory(), 
                        "Views", "index.html");
